...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
	...
	{
		echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'basic-details'));
	}
	...
	if ($this->params->get('presentation_style') == 'tabs')
	{
		echo JHtml::_('bootstrap.addTab', 'myTab', 'basic-details', JText::_('COM_CONTACT_DETAILS', true));
	}
	...
	if ($this->params->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id))
	{
		...
		if ($this->params->get('presentation_style') == 'tabs')
		{
			echo JHtml::_('bootstrap.addTab', 'myTab', 'display-form', JText::_('COM_CONTACT_EMAIL_FORM', true));
		}
	...
	if ($this->params->get('show_articles') && $this->contact->user_id && $this->contact->articles)
	{
		...
		if ($this->params->get('presentation_style') == 'tabs')
		{
			echo JHtml::_('bootstrap.addTab', 'myTab', 'display-articles', JText::_('JGLOBAL_ARTICLES', true));
		}
	...
	if ($this->contact->misc && $this->params->get('show_misc'))
	{
			...
			if ($this->params->get('presentation_style') == 'tabs')
			{
				echo JHtml::_('bootstrap.addTab', 'myTab', 'display-misc', JText::_('COM_CONTACT_OTHER_INFORMATION', true));
			}
